...
from JJMumbleBot.plugins.core.bot_commands.bot_commands import Plugin
...
class TestBotCommands:
    def setup_method(self):
        ...
        self.cfg.read(f"{get_core_plugin_dir()}/bot_commands/metadata.ini")
