...
def setup_aliases_debug():
    with open("%s/aliases/aliases.csv" % utils.get_main_dir(), mode='r') as csvf:
...
def clear_aliases():
    aliases.clear()
    with open("%s/aliases/aliases.csv" % utils.get_main_dir(), mode='w') as csvf:
...
def add_to_aliases(alias, command):
    with open("%s/aliases/aliases.csv" % utils.get_main_dir(), mode='a', newline='') as csvf:
...
def overwrite_aliases(content):
    try:
        with open("%s/aliases/aliases.csv" % utils.get_main_dir(), mode='w', newline='') as csvf:
